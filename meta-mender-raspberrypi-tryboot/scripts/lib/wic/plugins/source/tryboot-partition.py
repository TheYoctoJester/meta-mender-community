...
class TrybootPartitionPlugin(SourcePlugin):
    ...
    # wrynose's wic normalizes the WKS --source name (hyphen -> underscore)
    # before lookup, and built-in source plugins use underscore names, so the
    # registered name must be underscore-style to match "--source tryboot-partition".
