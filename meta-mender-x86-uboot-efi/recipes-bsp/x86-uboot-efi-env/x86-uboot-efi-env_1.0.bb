...
do_install() {
    ...
    install -d ${D}${bindir}
    install -m 0755 ${UNPACKDIR}/uboot-efi-bootentry.sh ${D}${bindir}/uboot-efi-bootentry.sh

    # Install the systemd service
    install -d ${D}${systemd_system_unitdir}
    install -m 0644 ${UNPACKDIR}/uboot-efi-bootentry.service ${D}${systemd_system_unitdir}/uboot-efi-bootentry.service
}
