...
|------|-------|--------------------|--------------------------|----|
| UKI | `meta-mender-uki` | `qemuarm64-uki` | systemd-boot Boot Loader Spec + boot counting on Unified Kernel Images | build + OTA |
...
| FWU | `meta-mender-fwu` | `qemuarm64-fwu` | U-Boot FWU multi-bank metadata + EFI capsule-on-disk | build + OTA |
